...
server.deserializeClient(function (id, done) {
    oauthClientService.getClient(id, function (err, client) {
...
exports.authorization = [
    server.authorization(function (clientID, redirectURI, done) {
        oauthClientService.getClient(clientID, function (err, client) {
            if (err) { return done(err); }
        ...
        oauthTokenService.getToken(client.app_id, function (err, token) {
            if (err) {
                return done(err);
            }
            return done(null, false);
